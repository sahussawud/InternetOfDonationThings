...
-สำหรับสิ่งของที่ลงทะเบียนไว้ สามารถติดตามสิ่งของเหล่านั้นได้ โดยกดปุ่มติดตามที่สิ่งของนั้น ก็จะมาที่หน้าการติดตาม โดยจะมี QR Code ในการติดตามสิ่งของ <br>

*** หน้าการตอบกลับ feed back ไปให้ผู้บริจาค สามารถตอบกลับได้โดยการสแกน QR Code ที่ได้ผูกไว้กับสิ่งของชิ้นนั้น เมื่อสแกนเสร็จก็สามารถเขียนข้อความส่งกลับไปยังผู้รับบริจาคได้ <br>

<li> 📝 My Project </li>
หน้าสำหรับ Recipient(ผู้รับบริจาค) ที่ใช้สำหรับแสดงรายละเอียดโครงการต่างๆที่ผู้รับริจาคได้สร้างไว้ในหน้า ✏️ สร้างโครงการรับบริจาค สามารถกดปุ่ม รายละเอียด เพื่อดูรายละเอียดโครงการเพิ่มเติมได้ <br>

<li> 📠 ลงทะเบียนของ </li>
หน้าสำหรับ Donor(ผู้บริจาค) ใช้สำหรับลงทะเบียนสิ่งของที่ต้องการบริจาค เมื่อกรอกข้อมูลครบแล้วจะไปที่หน้า 🎁 My Donations เพื่อแสดงรายการสิ่งของที่ลงทะเบียนไว้ทั้งหมด <br>

<li> ✏️ สร้างโครงการรับบริจาค </li>
หน้าสำหรับ Recipient(ผู้รับบริจาค) ที่ใช้สำหรับสร้างโครงการรับบริจาคต่างๆ เมื่อกรอกข้อมูลโครงการและกดปุ่มสร้างเสร็จแล้ว สามารถมาดูรายละเอียดโครงการทั้งหมดที่ได้สร้างไว้ได้ที่หน้า My Project <br>
